...
@StripeEventBind(StripeEventType.PAYMENT_INTENT_SUCCEEDED)
@Slf4j
@Component
public class StripePaymentIntentSucceededConsumer implements StripeEventConsumer {

    @Override
    public void consume(Event event) {
        // TODO: Implement the logic to consume the payment intent succeeded event
    }
}
